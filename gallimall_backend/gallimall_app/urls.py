...
from .views import (
    ...
    logout_view,
    latest_prices,
    CustomerProfileView, CustomerProfileUpdateView, FavouriteItemViewSet, FavouriteShopViewSet, PromotionViewSet,SmartSuggestionViewSet,PopularProductViewSet,vendor_orders,vendor_revenue_summary,ContactMessageViewSet
)
